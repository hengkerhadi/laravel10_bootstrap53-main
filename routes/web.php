...
use App\Http\Controllers\NilaiHadiController;
...
Route::group(['middleware' => 'auth'], function (){
    ...
    Route::get('nilai', [NilaiHadiController::class, 'index'])->name('nilai.index');
    Route::get('cetak_nilai', [NilaiHadiController::class, 'cetak_nilai'])->name('cetak_nilai');
